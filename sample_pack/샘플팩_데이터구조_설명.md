# 📦 샘플팩 데이터 구조 설명 — "프로그래밍 언어 생태계"
### — nodes.jsonl / edges.jsonl / documents.jsonl / chunks.jsonl 각 파일의 역할과 형식 —
### 대상: 온톨로지 데이터가 실제로 어떻게 생겼는지 파일 단위로 이해하고 싶을 때

> 이 샘플은 9가지 시맨틱 스페이스를 실제 데이터로 체험하기 위한 연습용 데이터셋입니다.  
> Python 언어 생태계를 도메인으로 삼아 노드 34개, 엣지 48개로 구성되어 있습니다.
